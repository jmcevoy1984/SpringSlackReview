...
class NullFieldChecker {
    ...
    public ResponseEntity getNullHttpResponse() {
        ...
        return ResponseEntity.status(400).body(new JSONObject(jsonResponse).toString());
...
public class ReviewController {
    ...
    public ResponseEntity newReview(@RequestBody Review review) {
        ...
        String slackWebhookURL = "https://hooks.slack.com/services/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";
